...
void plotVM(TString name="phi"){
	...
	int vm_index=-1;
	if(name=="rho"){base1->GetYaxis()->SetRangeUser(0, 4e4);vm_index=0;}
	if(name=="phi"){base1->GetYaxis()->SetRangeUser(0, 3e3);vm_index=1;}
	if(name=="jpsi"){base1->GetYaxis()->SetRangeUser(0, 5e2);vm_index=2;}//jpsi nodecay.
	...
	w5->AddEntry(h_VM[0][vm_index][1], "BeAGLE elas. "+legendName+" daug. incoh. ", "P");
	w5->AddEntry(h_VM[1][vm_index][1], "BeAGLE diss. "+legendName+" daug. incoh. ", "P");
	w5->Draw("same");
	...
	if(name=="rho"){base2->GetYaxis()->SetRangeUser(0, 4e4);vm_index=0;}
	if(name=="phi"){base2->GetYaxis()->SetRangeUser(0, 3e3);vm_index=1;}
	if(name=="jpsi"){base2->GetYaxis()->SetRangeUser(0, 5e2);vm_index=2;}//jpsi nodecay.
